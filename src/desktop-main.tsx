...
import { LicenseWindow, type Entitlement } from "./components/LicenseWindow";
...
declare global {
  interface Window { printDeskDesktop?: {
    ...
    selectLicenseFile:()=>Promise<{ok?:boolean;cancelled?:boolean;key?:string;fileName?:string;error?:string}>;
...
function DesktopApp() {
  ...
  const [licenseWindowOpen, setLicenseWindowOpen] = useState(true);
